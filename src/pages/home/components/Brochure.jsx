...
const Brochure = () => {
	...
	return (
		<div className='bg-lightBlack w-full mt-44 px-[10%] flex flex-col justify-center items-center'>
			<img
				src={BrochureImg}
			...
			<div className='text-white lg:grid lg:grid-cols-5 max-lg:py-4'>
				...
				<img
					src={BrochureImg}
					className='h-[400px] w-full object-fill col-start-4 col-span-2 -mt-28 hidden lg:block'
				/>
			</div>
